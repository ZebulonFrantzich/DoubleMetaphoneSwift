...
DESC
  ...
  # Or just: s.author    = "Zebulon Frantzich"
  # s.authors            = { "Zebulon Frantzich" => "zeb.frantzich@agapered.com" }
  # s.social_media_url   = "http://twitter.com/Zebulon Frantzich"
  ...
  s.pod_target_xcconfig = {'SWIFT_INCLUDE_PATHS' => '$(SRCROOT)/DoubleMetaphoneSwift/DoubleMetaphoneSwift/double_metaphone/**'}
